(() => {
  ...
  function buildScene() {
    ...
    // 藍線輪廓是從實物正上方照片一度一度量出來、再用保留缺口直壁的平滑處理過的表：0° = 右、90° = 下，值 = 相對大圓的半徑
    // 讀起來就是：一個大圓 + 上緣兩個凸出來的圓弧（頂點約 0.92R，肩膀處平順接回大圓）+ 中間方形缺口（寬 25°、底 0.61R）
    const RAIL_PROFILE = [
      ...
      0.992, 0.988, 0.983, 0.978, 0.973, 0.967, 0.961, 0.955, 0.950, 0.944, 0.939, 0.935,
      0.931, 0.928, 0.924, 0.922, 0.919, 0.917, 0.916, 0.916, 0.916, 0.916, 0.916, 0.917,
      0.917, 0.916, 0.915, 0.914, 0.912, 0.909, 0.906, 0.903, 0.901, 0.898, 0.896, 0.894,
      0.893, 0.892, 0.892, 0.892, 0.893, 0.894, 0.895, 0.896, 0.897, 0.897, 0.897, 0.897,
      0.896, 0.894, 0.892, 0.889, 0.884, 0.879, 0.874, 0.867, 0.859, 0.850, 0.841, 0.832,
      0.822, 0.808, 0.789, 0.791, 0.756, 0.713, 0.663, 0.608, 0.608, 0.608, 0.608, 0.608,
      0.608, 0.608, 0.608, 0.608, 0.608, 0.608, 0.608, 0.608, 0.608, 0.608, 0.608, 0.608,
      0.608, 0.608, 0.608, 0.608, 0.608, 0.633, 0.645, 0.701, 0.748, 0.777, 0.782, 0.801,
      0.816, 0.825, 0.835, 0.845, 0.856, 0.864, 0.872, 0.879, 0.884, 0.889, 0.893, 0.896,
      0.899, 0.901, 0.902, 0.903, 0.903, 0.902, 0.901, 0.900, 0.899, 0.898, 0.897, 0.896,
      0.895, 0.894, 0.894, 0.895, 0.895, 0.897, 0.899, 0.901, 0.903, 0.904, 0.906, 0.907,
      0.909, 0.910, 0.911, 0.912, 0.913, 0.914, 0.916, 0.918, 0.920, 0.923, 0.925, 0.929,
      0.932, 0.936, 0.941, 0.945, 0.951, 0.956, 0.962, 0.968, 0.973, 0.979, 0.983, 0.988,
      0.992, 0.995, 0.997, 0.999, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000,
    ];
