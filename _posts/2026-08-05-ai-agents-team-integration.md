...
description: 從 Automation Team 的多人 vibe coding 失控現場，重新思考 AI 協作在 Agent 時代的需求、分工與 BDD 驗收。
date: 2026-08-05 22:00:00 +0800
image: /assets/og-post-agents.jpg
...
說穿了就是 Garbage in, garbage out。需求沒說清楚、修改邊界沒定義，Agent 很快就把團隊原本沒處理好的問題全部放大了。
...
每個變更都不大，但四個人帶著各自的 Agent，仍然主要靠 task 分工。每個人各自理解需求、修改自己的部分。整合時，團隊才開始處理重複的 Component、互相衝突的修改，還要確認前端既有功能有沒有被改壞，以及問題究竟出在前端還是 API 回傳。
...
目前 Specformula 仍是我們團隊正在開發、需要放進真實多人專案驗證的解法。
